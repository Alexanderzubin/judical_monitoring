...
class User(Base):
    ...
    tg_id = Column(Integer, unique=True, nullable=False, comment='индентификтор пользователя в telegram')
    ...
    chat_id = Column(Integer, nullable=False, comment='идентификтор чата с пользователем')
