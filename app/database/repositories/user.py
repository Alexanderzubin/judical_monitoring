...
class UserRepository:
    ...
    def create(
        ...
        try:
            ...
            logger.error(f'Database error while creating user: {exc}')
    ...
    def delete(self, user_id: int) -> bool:
        try:
            ...
            self.session.rollback()
            logger.error(f'Database error while deleting user: {exc}')
    ...
    def get_by_tg_id(self, tg_id: int) -> User | None:
        try:
            ...
            self.session.rollback()
            logger.error(f'Database error while get user by tg id: {exc}')
